          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                   For a one-time price of $2999, HoloUS box is all you need to run the HoloUS application.<sup>*</sup>
                  </p>
              </div>
              <div className={
                classNames(
                ...
                <Image
                  src={require('./../../assets/images/gesc-087_gesc_087_01_800x800_new.png')}
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  The ultrasound image is always in front of the proceduralist. 
                  </p>
              </div>
              <div className={
                classNames(
